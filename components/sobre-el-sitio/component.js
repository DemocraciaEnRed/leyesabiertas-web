...
export default () => (
  <section>
    ...
    <StyledDiv>
      <StaticInfoP>
      El Portal de Leyes Abiertas es un desarrollo basado en la tecnología provista por Democracia en Red, coordinado por el Programa de Modernización de la Cámara de Diputados.
      </StaticInfoP>
      <StaticInfoP>
