...
export default () => (
  <section>
    ...
    <StaticInfoP>
    La Plataforma es un desarrollo basado en DemocracyOS, una plataforma online de código abierto, diseñada para informar, debatir y votar propuestas públicas hacia la construcción de una democracia adaptada al siglo XXI. DemocracyOS es desarrollada por la Fundación Democracia en Red.
    </StaticInfoP>
    <StaticInfoP>
      <u>Registro </u>
    </StaticInfoP>
    <StaticInfoP>
      ...
      La información personal suministrada al momento del registro a la Plataforma está protegida con una clave, y sólo el Usuario podrá modificarla. 
